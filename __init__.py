...
class AstronautilusWebWorld(WebWorld):
    ...
    option_groups = astronautilus_option_groups
...
class AstronautilusWorld(World):
    ...
    # Class Data
    game = "Astronautilus"
    web = AstronautilusWebWorld()
    options_dataclass = AstronautilusOptions
    options: AstonautilusOptions
    ...
    def create_item(self, name: str) -> AstronautilusItem:
        ...
        if getattr(self, "strawberries_required", None) and name == ItemName.strawberry:
            ...
            return AstronautilusItem(name, classification, item_data_table[name].code, self.player)
        else:
            return AstronautilusItem(name, item_data_table[name].type, item_data_table[name].code, self.player)
